...
CUSTOM_ALIVE_TEXT = Config.CUSTOM_ALIVE_TEXT or "✮ NAZRIYA IS RUNNING SUCCESSFULLY ✮"
...
async def amireallyalive(alive):
    ...
    if CAT_IMG:
        ...
        cat_caption += "   **[❣️DEPLOY DANGER_CAT❣️]**(https://github.com/MR-JINN-OF-TG/NAZRI-CAT) "
        ...
        await edit_or_reply(
            ...
            f"**{EMOJI} NAZRIYA Version :** `{catversion}`\n"
...
async def amireallyalive(alive):
    ...
    reply_to_id = await reply_id(alive)
    cat_caption = f"**NAZRIYA is Up and Running**\n"
    cat_caption += f"**  -Telethon version :** `{version.__version__}\n`"
    cat_caption += f"**  -NAZRIYA Version :** `{catversion}`\n"
